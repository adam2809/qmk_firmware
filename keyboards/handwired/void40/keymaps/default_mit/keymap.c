...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LGUI, KC_NO, KC_RALT, MO(_LOWER),      KC_SPC,        MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
[_APEX] = LAYOUT_planck_mit(
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,
    _______,KC_1   ,KC_3   ,_______,KC_4   ,    _______    ,_______,_______,_______,_______,_______
),
...
[_LOWER] = LAYOUT_planck_mit(
    KC_GESC, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_MPLY,     KC_TRNS, KC_MPRV, KC_VOLD, KC_VOLU, TG(_APEX)
),
