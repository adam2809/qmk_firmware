...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_planck_mit(KC_GESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT, KC_LCTL, KC_LGUI, KC_NO, KC_LALT, MO(2), KC_SPC, MO(3), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
	...
	[_RAISE] = LAYOUT_planck_mit(KC_TRNS, KC_PIPE, KC_PLUS, KC_AT, KC_HASH, KC_DLR, KC_NO, KC_RPRN, KC_RBRC, KC_RCBR, KC_NO, KC_DEL, KC_TRNS, KC_EXLM, KC_EQL, KC_UNDS, KC_ASTR, KC_BSLS, KC_NO, KC_LPRN, KC_LBRC, KC_LCBR, KC_NO, KC_NO, KC_TRNS, KC_AMPR, KC_MINS, KC_NO, KC_NO, KC_PERC, KC_CIRC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_PGUP, KC_END),
